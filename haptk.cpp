...
static void help() {
  ...
  cout << endl;
  cout << "Commands:" << endl;
  cout << "    convert     Convert SAM/BAM format to mHap format" << endl;
  cout << "    merge       Merge multiple sorted mHap files" << endl;
  cout << "    beta        Summarize CpG site-level methylation from mHap file" << endl;
